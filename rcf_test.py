...
def single_scale_test(model, test_loader, test_list, save_dir):
    ...
    for idx, image in enumerate(test_loader):
        ...
        torchvision.utils.save_image(
            1 - all_res, osp.join(save_dir, '%s.jpg' % filename))
...
if __name__ == '__main__':
    gpu = '0'
    checkpoint = r"E:\Program\project\DeelpLearning\edge\mslf1.pth"
    save_dir = r"E:\Program\project\DeelpLearning\edge\results\rcf_test"
    dataset = r"E:\Program\project\DeelpLearning\edge\data"
    ...
    test_dataset = BSDS_Dataset(root=dataset, split='test')
    print("="*100)
