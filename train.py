...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-dir', help='output folder', default='results/RCFatten')
    ...
    model = MSLF(pretrained=None).cuda()
    ...
    for pname, p in model.named_parameters():
        if pname in ['conv1_1.weight','conv1_2.weight',
                     'conv2_1.weight','conv2_2.weight','conv2_3.weight','conv2_4.weight','conv2_5.weight','conv2_6.weight',
                     'conv3_1.weight','conv3_2.weight','conv3_3.weight','conv3_4.weight','conv3_5.weight','conv3_6.weight','conv3_7.weight','conv3_8.weight',
                     'conv4_1.weight','conv4_2.weight','conv4_3.weight','conv4_4.weight','conv4_5.weight','conv4_6.weight','conv4_7.weight','conv4_8.weight',
                     'conv4_9.weight','conv4_10.weight','conv4_11.weight','conv4_12.weight',]:
            parameters['conv1-4.weight'].append(p)
        elif pname in ['conv1_1.bias','conv1_2.bias',
                     'conv2_1.bias','conv2_2.bias','conv2_3.bias','conv2_4.bias','conv2_5.bias','conv2_6.bias',
                     'conv3_1.bias','conv3_2.bias','conv3_3.bias','conv3_4.bias','conv3_5.bias','conv3_6.bias','conv3_7.bias','conv3_8.bias',
                     'conv4_1.bias','conv4_2.bias','conv4_3.bias','conv4_4.bias','conv4_5.bias','conv4_6.bias','conv4_7.bias','conv4_8.bias',
                     'conv4_9.bias','conv4_10.bias','conv4_11.bias','conv4_12.bias',]:
            parameters['conv1-4.bias'].append(p)
        elif pname in ['conv5_1.weight','conv5_2.weight','conv5_3.weight','conv5_4.weight','conv5_5.weight','conv5_6.weight']:
            parameters['conv5.weight'].append(p)
        elif pname in ['conv5_1.bias','conv5_2.bias','conv5_3.bias','conv5_4.bias','conv5_5.bias','conv5_6.bias']:
            parameters['conv5.bias'].append(p)
        elif pname in ['conv1_1_down.weight','conv1_2_down.weight',
                     'conv2_1_down.weight','conv2_2_down.weight','conv2_3_down.weight','conv2_4_down.weight','conv2_5_down.weight','conv2_6_down.weight',
                     'conv3_1_down.weight','conv3_2_down.weight','conv3_3_down.weight','conv3_4_down.weight','conv3_5_down.weight','conv3_6_down.weight','conv3_7_down.weight','conv3_8_down.weight',
                     'conv4_1_down.weight','conv4_2_down.weight','conv4_3_down.weight','conv4_4_down.weight','conv4_5_down.weight','conv4_6_down.weight','conv4_7_down.weight','conv4_8_down.weight',
                     'conv4_9_down.weight','conv4_10_down.weight','conv4_11_down.weight','conv4_12_down.weight',]:
            parameters['conv_down_1-5.weight'].append(p)
        elif pname in ['conv1_1_down.bias','conv1_2_down.bias',
                     'conv2_1_down.bias','conv2_2_down.bias','conv2_3_down.bias','conv2_4_down.bias','conv2_5_down.bias','conv2_6_down.bias',
                     'conv3_1_down.bias','conv3_2_down.bias','conv3_3_down.bias','conv3_4_down.bias','conv3_5_down.bias','conv3_6_down.bias','conv3_7_down.bias','conv3_8_down.bias',
                     'conv4_1_down.bias','conv4_2_down.bias','conv4_3_down.bias','conv4_4_down.bias','conv4_5_down.bias','conv4_6_down.bias','conv4_7_down.bias','conv4_8_down.bias',
                     'conv4_9_down.bias','conv4_10_down.bias','conv4_11_down.bias','conv4_12_down.bias',]:
